...
(function ($) {
	...
	if ($('.tp-team-item').length > 0 || $('.parallax-textline').length > 0) {
	...
	if ($('.parallax-text-line-2').length > 0) {
		gsap.set('.tp-project-textline-2', {
			x: '0%'
		});

		gsap.timeline({
			scrollTrigger: {
				trigger: '.tp-project-textline-2',
				start: '-1500 10%',
				end: 'bottom 20%',
				scrub: true,
				invalidateOnRefresh: true
